...
function joinRoom(code) {
    ...
    if (offerData) {
        ...
        // Different computer - need to get offer from room creator
        // For now, show a message that they need to be on the same browser
        // In a real implementation, you'd use a signaling server or manual exchange
        alert('Room not found. Make sure you\'re using the same browser, or ask the room creator to share the connection code.');
        joinRoomModal.classList.remove('hidden');
    }
}
